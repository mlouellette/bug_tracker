...
export default function InfoCard() {
    ...
    return <Card className="custom-card" style={{ borderRadius: '5px' }} body>
            <center><h3>INFO - COMMENTS</h3></center>
                <Container>
                    <Row>
                        <Col xs lg="3">
                        ...
                        <div
                            ...
                            style={{ minHeight: '240px', maxHeight: '240px', overflowY: 'auto', borderRadius: '5px'  }}
                        >
                            <ToastContainer
